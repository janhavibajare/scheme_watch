      ...
      <div className="container my-5">
        <div className="card p-4 shadow-lg w-100 mx-auto">
          ...
          <form>
            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                <label className="form-label">शालेय पोषण आहार शिक्षकाचे नाव</label>
                <input
                  type="text"
                  className="form-control"
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleTeacherChange("teacherFemale", e.target.value)}
                  style={inputStyle}
                  required
                />
              </div>
              <div className="col-md-4 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleTeacherChange("teacherMale", e.target.value)}
                  style={inputStyle}
                  required
                />
              </div>
              <div className="col-md-4 mb-3">
                ...
                <input
                  type="number"
                  className="form-control"
                  value={displayValue((formData.teacherMale || 0) + (formData.teacherFemale || 0))}
                  style={inputStyle}
                  readOnly
                />
              </div>
            ...
            <div className="row">
              ...
              <div className="col-md-4 mb-3">
                ...
                <input
                  type="number"
                  className="form-control"
                  value={displayValue((formData.totalBoys || 0) + (formData.totalGirls || 0))}
                  style={inputStyle}
                  readOnly
                />
              </div>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleStudentChange("grade1to4", "girls", e.target.value)}
                  style={inputStyle}
                  required
                />
              </div>
              <div className="col-md-4 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleStudentChange("grade1to4", "boys", e.target.value)}
                  style={inputStyle}
                  required
                />
              </div>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleStudentChange("grade5to7", "girls", e.target.value)}
                  style={inputStyle}
                  required
                />
              </div>
              <div className="col-md-4 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleStudentChange("grade5to7", "boys", e.target.value)}
                  style={inputStyle}
                  required
                />
              </div>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleStudentChange("grade8to10", "girls", e.target.value)}
                  style={inputStyle}
                  required
                />
              </div>
              <div className="col-md-4 mb-3">
                ...
                <input
                  ...
                  onChange={(e) => handleStudentChange("grade8to10", "boys", e.target.value)}
                  style={inputStyle}
                  required
                />
              </div>
      ...
      <div className="container my-5">
        <div className="card p-4 shadow-lg w-100 mx-auto">
          ...
          <form>
            <div className="row">
              <div className="col-md-4 mb-3">
                <label className="form-label">१. मध्यान्ह भोजन माहिती फलक आहे का?</label>
                <select
                  className="form-select"
                  name="hasMiddayMealBoard"
                  value={formData.hasMiddayMealBoard ?? ""}
                  onChange={(e) => handleBinaryChange("hasMiddayMealBoard", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
              ...
              <div className="col-md-4 mb-3">
                ...
                <select
                  ...
                  onChange={(e) => handleBinaryChange("hasMiddayMealMenu", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">३. शाळा व्यवस्थापन समिती बोर्ड आहे का?</label>
                <select
                  className="form-select"
                  name="hasManagementBoard"
                  value={formData.hasManagementBoard ?? ""}
                  onChange={(e) => handleBinaryChange("hasManagementBoard", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
            ...
            {/* Repeat for other fields, using handleBinaryChange for selects */}
            <div className="row">
              <div className="col-md-4 mb-3">
                <label className="form-label">४. मुख्याध्यापक यांचा संपर्क क्रमांक आहे का?</label>
                <select
                  className="form-select"
                  name="hasPrincipalContact"
                  value={formData.hasPrincipalContact ?? ""}
                  onChange={(e) => handleBinaryChange("hasPrincipalContact", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">५. तालुका/जिल्हास्तरीय अधिकाऱ्यांचा क्रमांक आहे का?</label>
                <select
                  className="form-select"
                  name="hasOfficerContact"
                  value={formData.hasOfficerContact ?? ""}
                  onChange={(e) => handleBinaryChange("hasOfficerContact", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">६. मध्यान्ह भोजन बाबत तक्रार पेटी आहे का?</label>
                <select
                  className="form-select"
                  name="hasComplaintBox"
                  value={formData.hasComplaintBox ?? ""}
                  onChange={(e) => handleBinaryChange("hasComplaintBox", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                <label className="form-label">७. शाळा परिसरात आपत्कालीन दूरध्वनी क्रमांक भिंती वर शाळेला आहे का?</label>
                <select
                  className="form-select"
                  name="hasEmergencyNumber"
                  value={formData.hasEmergencyNumber ?? ""}
                  onChange={(e) => handleBinaryChange("hasEmergencyNumber", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">८. शाळा परिसरात किचनशेड उपलब्ध आहे काय?</label>
                <select
                  className="form-select"
                  name="hasKitchenShed"
                  value={formData.hasKitchenShed ?? ""}
                  onChange={(e) => handleBinaryChange("hasKitchenShed", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">९. शाळेमध्ये प्रार्थमोपचार पेटी उपलब्ध आहे काय?</label>
                <select
                  className="form-select"
                  name="hasFirstAidBox"
                  value={formData.hasFirstAidBox ?? ""}
                  onChange={(e) => handleBinaryChange("hasFirstAidBox", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                <label className="form-label">१०. शाळेमध्ये पिण्याच्या पाण्याचे स्रोत आहे का?</label>
                <select
                  className="form-select"
                  name="hasWaterSource"
                  value={formData.hasWaterSource ?? ""}
                  onChange={(e) => handleBinaryChange("hasWaterSource", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">१०.२ पाणी पुरवठा नियमित आहे का?</label>
                <select
                  className="form-select"
                  name="hasRegularWaterSupply"
                  value={formData.hasRegularWaterSupply ?? ""}
                  onChange={(e) => handleBinaryChange("hasRegularWaterSupply", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                <label className="form-label">११. शाळेमध्ये आपत्कालीन परिस्थितीत अग्निशमन उपकरणे (Fire Extinguisher) उपलब्ध आहेत का?</label>
                <select
                  className="form-select"
                  name="hasFireExtinguisher"
                  value={formData.hasFireExtinguisher ?? ""}
                  onChange={(e) => handleBinaryChange("hasFireExtinguisher", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">११.१ असलयास, नियत कालावधीनंतर उपकरणाची तपासणीच्या रजिस्टरवर नोंदी घेण्यात येतात का?</label>
                <select
                  className="form-select"
                  name="hasFireExtinguisherCheck"
                  value={formData.hasFireExtinguisherCheck ?? ""}
                  onChange={(e) => handleBinaryChange("hasFireExtinguisherCheck", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">११.२ उपकरणाचे पुनर्भरण नियमितपणे करण्यात येते का?</label>
                <select
                  className="form-select"
                  name="hasFireExtinguisherRefill"
                  value={formData.hasFireExtinguisherRefill ?? ""}
                  onChange={(e) => handleBinaryChange("hasFireExtinguisherRefill", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                <label className="form-label">११.३ असलयास थोडक्यात तपशील (सन २०२२ ते २०२४)</label>
                <textarea
                  className="form-control"
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">१२. शाळेमध्ये परसबाग विकसित करण्यात आलेली आहे काय?</label>
                <select
                  className="form-select"
                  name="hasKitchenGarden"
                  value={formData.hasKitchenGarden ?? ""}
                  onChange={(e) => handleBinaryChange("hasKitchenGarden", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">१२.१ असलयास परसबागेतील पालेभाज्या/फळे आहारात वापरले जातात काय?</label>
                <select
                  className="form-select"
                  name="usesGardenProduce"
                  value={formData.usesGardenProduce ?? ""}
                  onChange={(e) => handleBinaryChange("usesGardenProduce", e.target.value)}
                  required
                >
                  <option value="">निवडा</option>
                  <option value="1">होय</option>
            ...
            <div className="row">
              <div className="col-md-4 mb-3">
                <label className="form-label">१२.२ असलयास थोडक्यात तपशील</label>
                <textarea
                  className="form-control"
              ...
              <div className="col-md-4 mb-3">
                <label className="form-label">१३. नाविन्यपूर्ण उपक्रमांचा तपशील</label>
                <textarea
                  className="form-control"
